...
export class PaymentsController extends BaseController {
     ...
     */
    async captureAuthorizedPayment({ authorizationId, paypalMockResponse, paypalRequestId, prefer, paypalAuthAssertion, body, }, requestOptions) {
     ...
     * @return Response from the API call
     */
    async getCapturedPayment({ captureId, paypalMockResponse, }, requestOptions) {
     ...
     * @return Response from the API call
     */
    async reauthorizePayment({ authorizationId, paypalRequestId, prefer, paypalAuthAssertion, body, }, requestOptions) {
        const req = this.createRequest('POST');
        const mapped = req.prepareArgs({
            authorizationId: [authorizationId, string()],
            paypalRequestId: [paypalRequestId, optional(string())],
     ...
     * @return Response from the API call
     */
    async voidPayment({ authorizationId, paypalMockResponse, paypalAuthAssertion, paypalRequestId, prefer, }, requestOptions) {
        const req = this.createRequest('POST');
        const mapped = req.prepareArgs({
            authorizationId: [authorizationId, string()],
            paypalMockResponse: [paypalMockResponse, optional(string())],
     ...
     * @return Response from the API call
     */
    async refundCapturedPayment({ captureId, paypalMockResponse, paypalRequestId, prefer, paypalAuthAssertion, body, }, requestOptions) {
        const req = this.createRequest('POST');
        const mapped = req.prepareArgs({
            captureId: [captureId, string()],
            paypalMockResponse: [paypalMockResponse, optional(string())],
     ...
     * @return Response from the API call
     */
    async getAuthorizedPayment({ authorizationId, paypalMockResponse, paypalAuthAssertion, }, requestOptions) {
        const req = this.createRequest('GET');
        const mapped = req.prepareArgs({
            authorizationId: [authorizationId, string()],
            paypalMockResponse: [paypalMockResponse, optional(string())],
     ...
     * @return Response from the API call
     */
    async getRefund({ refundId, paypalMockResponse, paypalAuthAssertion, }, requestOptions) {
        const req = this.createRequest('GET');
        const mapped = req.prepareArgs({
