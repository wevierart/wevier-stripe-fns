...
export class VaultController extends BaseController {
     ...
     */
    async deletePaymentToken(id, requestOptions) {
     ...
     * @return Response from the API call
     */
    async createSetupToken({ body, paypalRequestId, }, requestOptions) {
     ...
     * @return Response from the API call
     */
    async getSetupToken(id, requestOptions) {
     ...
     * @return Response from the API call
     */
    async createPaymentToken({ body, paypalRequestId, }, requestOptions) {
     ...
     * @return Response from the API call
     */
    async listCustomerPaymentTokens({ customerId, pageSize, page, totalRequired, }, requestOptions) {
     ...
     * @return Response from the API call
     */
    async getPaymentToken(id, requestOptions) {
        const req = this.createRequest('GET');
        const mapped = req.prepareArgs({ id: [id, string()] });
        req.appendTemplatePath `/v3/vault/payment-tokens/${mapped.id}`;
        req.throwOn(403, CustomError, 'Authorization failed due to insufficient permissions.');
